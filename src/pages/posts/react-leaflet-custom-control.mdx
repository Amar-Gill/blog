...
- The `useMap` hook returns the root `<MapContainer>` reference for any of it's child components.
...
```
Let's add the component as a child of the `<MapContainer>` component:
