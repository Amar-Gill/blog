...
- The `Control.extend` method returns a class that implements the leaflet `Control` type.
- The `useMap` hook returns the `<MapContainer>` reference of the child component.
