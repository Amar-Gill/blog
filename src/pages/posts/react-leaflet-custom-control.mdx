...
The [React Leaflet](https://react-leaflet.js.org/) package provides React bindings for the Leaflet package. In this post I demonstrate how to create a map component with address search functionality in a React app using the React Leaflet package and [Geoapify](https://www.geoapify.com/) API.

Through the process, you will learn how to add arbitrary HTML elements as custom controls to a React Leaflet map.

### Getting Started

Let's begin by rendering a basic map in our React app. Install the necessary dependencies:
...
Depending on the popularity of this post, there may be no credits left on the Geoapify free tier. Please use sparingly =]
</aside>
