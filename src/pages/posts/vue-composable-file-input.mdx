...
description: Using the Vue 3 composition api to obtain the base64 encoded url for a file plus it's file size.
...
I want to share a simple composable I used in a Vue project of mine. I wanted to upload a file to the backend, so I needed the base64 encoded url of the file.

Encoding a file to the base64 format allows you to send the file to a server through http, since the encoded url is just a string.
