...
I developed this composable while working on a side project with Nuxt 3. I wanted to upload a file to the backend, so I needed the base64 encoded url of the file.
