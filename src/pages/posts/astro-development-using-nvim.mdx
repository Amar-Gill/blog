...
I'm really happy with this plugin so far. It provides correct syntax highlighting of frontmatter which is `.yaml` format for `.mdx` files. It also highlights code blocks of all the languages I write about.
