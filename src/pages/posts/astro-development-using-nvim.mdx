...
- I use the document formatter provided by the Astro language server, and _not_ the [prettierd](https://github.com/fsouza/prettierd) built in formatting source via [null-ls](https://github.com/jose-elias-alvarez/null-ls.nvim/blob/main/doc/BUILTINS.md#prettierd). [Why](#formatting)?
